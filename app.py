...
js = Bundle(
    # coffeescripts
    Bundle('js/*.coffee', filters='coffeescript', output='gen/jobylon.%(version)s.coffee.js', debug=False),
    filters=('jsmin', 'jspacker'),
    output='gen/krh.%(version)s.min.js')
...
less = Bundle('css/*.less', filters='less', output='gen/jobylon.%(version)s.less.css', debug=True)
